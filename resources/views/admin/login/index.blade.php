...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <!-- CSS -->
        <link rel="stylesheet" href="/css/admin/login/reset.css">
        <link rel="stylesheet" href="/css/admin/login/supersized.css">
    ...
    <body oncontextmenu="return false">
        ...
        <script src="/js/admin/login/supersized.3.2.7.min.js"></script>
        <script src="/js/admin/login/supersized-init.js"></script>
		<script>
		$(".btn").click(function(){
			is_hide();
		})
